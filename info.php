...
// Get the list of files in the "uploadInfo" folder
$uploadInfoPath = "uploadInfo/";
$uploadedImages = glob($uploadInfoPath . "*.{jpg,jpeg,png}", GLOB_BRACE);
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">INFORMATION</h1>
                    </div>
                            ...
                            <div class="card shadow mb-4 ps-10">
                                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">                     
                                    <div class="carousel-inner">
                                        <?php
                                        // Loop through each uploaded image and create a carousel item
