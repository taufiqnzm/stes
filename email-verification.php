        ...
        if ($codeTimestamp !== false) {
            ...
            if ($currentTimestamp - $codeTimestamp <= $codeValidityDuration) {
                ...
                $stmt->execute([$email]);
                    ...
                    // Provide a success message and show pop-up
                    echo '
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            Swal.fire({
                                ...
                                window.location.href = "user-details.php?email=' . $email . '"; // Redirect after showing the pop-up
                            });
                        });
                    </script>';
            } else {
...
<body style="background-image: url(img/background4.jpg); background-size: cover;">
    <div class="container ">
        <div class="card o-hidden border-0 shadow-lg " style="background-color: rgba(255, 255, 255, 0.5); margin-top:200px">
            <div class="card-body p-0 ">
                <div class="row">
                    <div class="col-10" style="margin: 20px auto;">
                        <div class="p-5">
                            <h2 style="text-align: center; color: black;" >Verification Email</h2><br>
                            <?php echo $message; ?>
                            <form action="" method="POST" style="text-align: center;">
                                <br><label for="verification_code" style="color: black;">Enter verification code</label>
                                ...
                                if (isset($_GET["email"])) {
                                    ...
                                    echo '<input type="hidden" name="email" value="' . $email . '"><br>
                                        <label for="resend" style="color: black;">Didn t receive the verification code?</label>
