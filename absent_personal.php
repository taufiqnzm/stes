...
$query = "SELECT applicants.name, DATE_FORMAT(applicants.start_date, '%d-%m-%Y') AS start_date, 
                 ...
                 applicants.time_leave, 
                 applicants.time_back, 
                 applicants.reason
          FROM applicants
          JOIN users ON applicants.user_id = users.user_id
          WHERE applicants.existence = 'Absent' AND applicants.user_id = :user_id
    ...
    `                       </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Personal History Ketidakhadiran</h1>
