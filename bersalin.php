...
$query = "SELECT cuti_bersalin_count FROM dashboard WHERE `date` = :currentDate";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Cuti Bersalin</h1>
                                                        ...
                                                        <div class="col">
                                                            <div class="progress progress-sm mr-2">
                                                                <div class="progress-bar bg-dark" role="progressbar"
                                                                    style="width: <?php echo $cuti_bersalin_count; ?>%" aria-valuenow="50" aria-valuemin="0"
