...
$query = "SELECT username, name, email, phone, address, major, pic FROM users WHERE is_admin = 1";
...
if ($stmt && $stmt->rowCount() > 0) {
    ...
    $major = "";
    $address = "";
    $adminPic = "img/userprofile.jpg"; // Provide a default image URL
}
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">DETAIL ADMIN</h1>
                    </div>
                                ...
                                <div class="col-lg-4">
                                  <div class="card mb-4">
                                    <div class="card-body text-center">
                                      <img src="<?php echo $adminPic; ?>" alt="avatar"
                                        class="rounded-circle img-fluid" style="width: 150px;">
                                      <h6 class="my-3"><?php echo $adminUsername; ?></h6>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-lg-8">
