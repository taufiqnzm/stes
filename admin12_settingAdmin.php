                                ...
                                <div class="col-lg-12">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <!-- <hr>
                                            <a href="admin15_downloadFile.php" style="color: black;">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <p class="mb-0">Download File</p>
                                                    </div>
                                                </div>
                                            </a> -->
                                            <!-- <hr>
                                            ...
                                            <hr>
                                            <a href="admin16_userManual.php" style="color: black;">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <p class="mb-0">User Manual</p>
                                                    </div>
                                                </div>
                                            </a>
                                            <hr>
                                            <!-- <a href="detail_admin.php" style="color: black;">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <p class="mb-0">Detail Admin</p>
                                                    </div>
                                                </div>
                                            </a> -->
                                        </div>
