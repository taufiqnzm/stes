...
<!-- include "calc_percentage.php"; -->
    ...
    <script>
        document.getElementById("list_official_business").addEventListener("click", function(event) {
        event.preventDefault(); // Prevent the default behavior of the link

        // Make an AJAX request to generate the absent report
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "generate_report.php?type=official_business", true); // Pass a parameter to indicate the report type
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                a.href = url;
                a.download = "list_official_business.csv"; // Modify the filename
