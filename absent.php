...
// Fetch the absent_teacher_count for today's date from the "dashboard" table
$query = "SELECT absent_teacher_count FROM dashboard WHERE `date` = :currentDate";
...
// Fetch data from the "applicants" table where existence is "Absent," and the current date is within the range of start_date and final_date
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Heading -->
            <div class="sidebar-heading" style="font-size: 16px;">
                MAIN
            </div>

            <li class="nav-item active">
                <a class="nav-link" href="stes_form.php">
                    <i class="fas fa-fw fa-list-alt" style="font-size: 16px;"></i>
                    <span style="font-size: 16px;">STES Form</span>
                </a>
            </li>
            <hr class="sidebar-divider">
            <li class="nav-item active">
                <a class="nav-link" href="users.php">
                    <i class="fas fa-fw fa-user-alt" style="font-size: 16px;"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="users.php" data-toggle="collapse" data-target="#collapseUsers"
                    ...
                    <i class="fas fa-fw fa-clock" style="font-size: 16px;"></i>
                    <span style="font-size: 16px;">History Personal</span>
                </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="info.php">
                    <i class="fas fa-fw fa-info-circle" style="font-size: 16px;"></i>
                    <span style="font-size: 16px;">School Info</span>
                </a>
        <!-----Section Divider-------->
            <hr class="sidebar-divider">
            </li>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="settings.php">
                    <i class="fas fa-fw fa-cog" style="font-size: 16px;"></i>
        ...
        <!-----Section Divider-------->
            ...
            <li class="nav-item active">
                <a class="nav-link" href="logout.php" data-toggle="modal" data-target="#logoutModal">
                    <i class="fas fa-fw fa-sign-out-alt" style="font-size: 16px;"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!-- <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="alertsDropdown" style="font-size: 16px;">
                                <h6 class="dropdown-header" style="font-size: 16px;">
                                    Notifications
                                </h6>
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="#" style="font-size: 16px;">Show All Alerts</a>
                            </div>
                        </li> -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown" style="font-size: 16px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" >Ketidakhadiran</h1>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto" style="font-size: 16px;">
