...
// Fetch the emergency_teacher_count for today's date from the "dashboard" table
$query = "SELECT keberadaan_jam_count FROM dashboard WHERE `date` = :currentDate";
...
// Fetch data from the "applicants" table where existence is "Emergency," and the current date is within the range of start_date and final_date
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Keberadaan 4 Jam</h1>
                        <!-- <a href="#" id="list_emergency" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                                        ...
                                                        <div class="col">
                                                            <div class="progress progress-sm mr-2">
                                                                <div class="progress-bar bg-dark" role="progressbar"
                                                                    style="width: <?php echo $keberadaan_jam_count; ?>%" aria-valuenow="50" aria-valuemin="0"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="font-size: 16px;">Ready to Leave?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body" style="font-size: 16px;">Select "Logout" below if you are ready to end your current session.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="logout.php" style="font-size: 16px;">Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.getElementById("list_emergency").addEventListener("click", function(event) {
        event.preventDefault(); // Prevent the default behavior of the link

        // Make an AJAX request to generate the absent report
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "generate_report.php?type=emergency", true); // Pass a parameter to indicate the report type
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                a.href = url;
                a.download = "list_emergency.csv"; // Modify the filename
