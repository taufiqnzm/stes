...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Keluar Tidak Lebih 4 Jam</h1>
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" onclick="window.print(); return false">
                            <i class="fas fa-download fa-sm text-white-50" style="font-size: 18px;"></i> Generate Report</a>
                    </div>
                        ...
                        <div class="col-xl-8 col-xl-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <div class="col-sm-4">
                                        <input type="date" class="form-control" id="inputStartDate" name="start_date" onchange="updateData('keberadaan_jam')">
                                    </div>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="teachers" class="table" style="font-size: 20px;">
                                            <thead>
                                            <tr>
                                                <th scope="col">No.</th>
    ...
    <script src="js/select_date_existence.js"></script>
