                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!-- <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#" style="font-size: 18px;">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="font-size: 16px;"><?php echo $username; ?></span>
                        ...
                        <div class="col-xl-8 col-xl-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <div class="col-sm-4">
                                        <input type="date" class="form-control" id="inputStartDate" name="start_date" onchange="updateData()">
                                    </div>
                                </div>
                                <!-- Card Body -->
